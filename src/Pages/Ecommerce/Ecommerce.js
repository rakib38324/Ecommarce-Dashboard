          ...
          <div className='lg:grid lg:grid-cols-3 m-2 gap-2'>
            <div>
              <div className='flex justify-between bg-white p-2 rounded-2xl'>
                <div className='flex'>
                  <p className='text-3xl bg-blue-400 my-auto p-2 rounded-lg text-white'><FaNewspaper></FaNewspaper></p>
                  <div className='pl-2'>
            ...
            <div>
              <div className='flex justify-between bg-white p-2 rounded-2xl'>
                <div className='flex'>
                  <p className='text-3xl bg-blue-400 my-auto p-2 rounded-lg text-white'><FaShoppingBag></FaShoppingBag></p>
                  <div className='pl-2'>
            ...
            <div>
              <div className='flex justify-between bg-white p-2 rounded-2xl'>
                <div className='flex'>
                  <p className='text-3xl bg-blue-400 my-auto p-2 rounded-lg text-white'><FaUsers></FaUsers></p>
                  <div className='pl-2'>
        ...
        <div className='col-span-3 bg-base-200'>
          ...
          <div className='m-2 '>
            ...
            <div className='  flex justify-center bg-white '>
              <img className="w-28 h-28 mt-[-60px] lg:w-24 lg:h-24 rounded-full border-white border-4 " src="https://i.ibb.co/xzt8fzv/Rakib-1.jpg" alt="Profile Picture" />
            </div>
            ...
            <div className='bg-white'>
              ...
              <div className='py-2'>
                ...
                <div className='flex lg:justify-between mb-3'>
                  ...
                  <div className='my-auto w-[75%]'>
                    <p className='truncate pr-1 text-slate-400'>Responded to need "Volunter Activities".</p>
                    <button className='font-bold text-blue-600'>Rea More</button>
                  </div>
                </div>
