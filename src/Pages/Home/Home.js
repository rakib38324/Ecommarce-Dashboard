                    ...
                    <ul className="menu p-4 w-80 bg-base-100 text-base-content text-white bg-gray-900">
                        ...
                        <div className="collapse">
                            ...
                            <div className="collapse-title text-xl font-medium flex ">
                                <spam className='my-auto mr-2'><FaBorderAll></FaBorderAll></spam>Dashboards <spam className='my-auto ml-auto'><FaAngleDown></FaAngleDown></spam>
                            </div>
                            <div className="collapse-content text-white font-semibold flex flex-col ml-7">
                                <Link to='/ecommerce' className=''>Ecommerce</Link>
                                <Link className='my-3'>Saas</Link>
